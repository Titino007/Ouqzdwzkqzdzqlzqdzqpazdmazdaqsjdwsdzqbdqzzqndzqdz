...
local Window = Library:CreateWindow({
    Title = 'Zeta Hub PREMIUM // By Jehno // Ouwigahara',
    Center = true,
    AutoShow = true,
})
...
local Ouwi = Tabs.Ouwi:AddRightGroupbox('           [Auto Collect Orbs]')
local Ouwi2 = Tabs.Ouwi:AddLeftGroupbox('              [Destroy Orbs]')
local Test = Tabs.Misc:AddRightGroupbox('              [Misc]')
local LeftGroupBox = Tabs.Main:AddRightGroupbox('           [Auto Farms]')
local RightGroupBox = Tabs.Main:AddLeftGroupbox('            [Status]')
local LeftGroupBox2 = Tabs.Main:AddRightGroupbox('           [Auto Farms]')
local LeftGroupBox5 = Tabs.Main:AddRightGroupbox('           [Auto Gourd]')
local RightGroupBox4 = Tabs.Main:AddLeftGroupbox('            [Other]')
local Test2 = Tabs.Misc:AddRightGroupbox('            [Training]')
local Test3 = Tabs.Misc:AddRightGroupbox('             [Modes]')
local Test4 = Tabs.Misc:AddLeftGroupbox('        [God Modes (DEMON)]')
local Test5 = Tabs.Misc:AddLeftGroupbox('  [God Modes (SLAYER/HUMAN)]')
local Shark1 = Tabs.Teleports:AddRightGroupbox('            [TELEPORTS]')
local Sharky1 = Tabs.Teleports:AddLeftGroupbox('            [SERVERS]')
local Shark2 = Tabs.Misc:AddLeftGroupbox('       [Auto Collect Lily]')
local Shark3 = Tabs.Misc:AddLeftGroupbox('       [Some Stuffs]')
